...
const EngineCore = ({ isActive, currentProfile }: EngineCoreProps) => {
    ...
    <div className="flex flex-col items-center justify-center py-8 gap-4">
      ...
      <div className="text-center">
        <p className="font-display font-semibold text-foreground">
          {isActive ? (currentProfile ? `Processing: ${currentProfile}` : "Engine Running") : "Engine Idle"}
        </p>
        <p className="text-xs text-muted-foreground font-body mt-1 uppercase tracking-widest">
          {isActive ? "Automation core engaged" : "Awaiting start command"}
        </p>
      </div>
    </div>
  );
